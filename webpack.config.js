...
if (!og_image_url)
    og_image_url =
        "https://riot.im/app/themes/riot/img/logos/riot-im-logo-black-text.png";
...
module.exports = {
    entry: {
        ...
        // CSS themes
        "theme-light":
            "./node_modules/matrix-react-sdk/res/themes/light/css/light.scss",
        "theme-dark":
            "./node_modules/matrix-react-sdk/res/themes/dark/css/dark.scss",
        "theme-light-custom":
            "./node_modules/matrix-react-sdk/res/themes/light-custom/css/light-custom.scss",
        "theme-dark-custom":
            "./node_modules/matrix-react-sdk/res/themes/dark-custom/css/dark-custom.scss"
    },
    module: {
        rules: [
            {
                ...
                oneOf: [
                    {
                        ...
                        options: {
                            ...
                            publicPath: function(url, resourcePath) {
                                ...
                                // twice.
                                const outputPath = getImgOutputPath(
                                    url,
                                    resourcePath
                                );
                                return toPublicPath(
    ...
    output: {
        ...
        devtoolModuleFilenameTemplate: function(info) {
            ...
            return path
                .relative(process.cwd(), info.resourcePath)
                .replace(/^[\/\.]*/, "");
        }
    },
    resolve: {
